...
- Action-Request Path Design — Action-Request Intent চেনা গেলে Assistant নিজে থেকে Action Execute করবে না; বরং (১) Request-টা কী Action এবং কোন Device/System-এ তা Confirm করবে, (২) Module 09B-এর RBAC/Approval Workflow-এ Request-টা Route করবে, (৩) Approval হলে সংশ্লিষ্ট Automation Trigger হবে, Approval না হলে বা Pending থাকলে Requester-কে সেই Status জানাবে
...
Nord Bank-এর NOC AI Assistant-কে "কয়টা Branch Down?" জিজ্ঞেস করলে এটা Monitoring Database Query করে একটা সংখ্যা ফেরত দেয় (Count Intent)। "কোন কোন Branch Down?" জিজ্ঞেস করলে এটা একই Database থেকে একটা তালিকা ফেরত দেয় (List Intent)। "Firewall Throughput কেমন যাচ্ছে গত ঘন্টায়?" জিজ্ঞেস করলে এটা একটা Trend Summary দেয় (Trend Intent)। আর "Dhanmondi Branch-এর Router Restart করো" বললে এটা Action-Request হিসেবে চেনে, নিজে Restart না করে সাথে সাথে On-Call Manager-এর কাছে Approval Request পাঠায়, এবং Requester-কে জানায় "Request Sent, Approval Pending।"
...
- Action-Request Path থাকলেও, Assistant নিজে কোনো Action Execute করে না — এটা শুধু Recognize করে Approval Chain-এ Route করে; তাই Approver Available না থাকলে (Vacation, Phone বন্ধ) Legitimate Urgent Action-ও আটকে থাকতে পারে, যদি Module 08.1B-এর মতো Backup Approver Chain আগে থেকে ঠিক করা না থাকে
